...
$id_gest=$_SESSION['id_gest'];



    
    $sql=$db->query("INSERT into messagerie (message,expediteur,date_envoie,objet,destinateur,vers) Values   ('{$msg}','{$id_gest}','{$date}','{$obj}','{$id_client}','vers1')");
        $sql2="INSERT into messagerie (message,expediteur,date_envoie,objet,destinateur,vers) Values   ('{$msg}','{$id_gest}','{$date}','{$obj}','{$id_client}','vers2')";
