    ...
    {           $namafolder="medi/"; 
                                                                    ...
                                                                    if(isset($_POST['presentation']))
                                                                         {
                                                                            $presentation=htmlspecialchars($_POST['presentation']);
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        $sql="insert into produits (id,nom,prix,quantite,categories,image,forme,presentation,dosage,quantite_achete,date_ajout,seuil) values ('$code','$nom','$prix','$quantite','$categorie',' $gambar','$forme','$presentation','$dosage','0','$date','1000')";
      ...
      {  
           echo "Produit ajouté";  
            ...
            }else{echo "Code produit invalide";}
