                  ...
                  <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                               <div style="text-align:center;"class="center"><h4>Commandes archivées</h4></div>
                            </div>
                            <div class="block-content collapse in">
                            	 <table class="table table-bordered table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            $rr="SELECT * FROM listecommande where (etat='archiver' and id_gest='{$_SESSION['id_gest']}')LIMIT $start, $per_page";
