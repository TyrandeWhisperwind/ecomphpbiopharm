                  ...
                  <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                               <div style="text-align:center;"class="center"><h4>Commandes abandonnées</h4></div>
                            </div>
                    ...
                    $rr="SELECT * FROM listecommande where (etat='abandonner' and id_gest='{$_SESSION['id_gest']}')LIMIT $start, $per_page";
											...
											?>
                                              ...
                                              <td width='90'><?php echo $data['date_envoie']; ?></td>
                                                    ...
                                                    <td><a href="details4.php?id=<?php echo $data['id_listecommande']; ?>" class="btn">
                                                     Afficher</a> 

                                                <a href="delete_cmd.php?id=<?php echo $data['id_listecommande']; ?>" class="btn btn-danger" class="btn"onclick="return confirm('Êtes-vous sûr ?')">Supprimer</a>  
