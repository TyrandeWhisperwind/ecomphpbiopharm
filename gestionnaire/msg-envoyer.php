                  ...
                  <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div style="text-align:center;"class="center"><h4>Messages envoyés</h4></div>
                            ...
                            <div class="block-content collapse in">
                                 <table class="table table-bordered table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            $rr="SELECT * FROM messagerie where vers='vers2' and expediteur='$iduser' LIMIT $start, $per_page";
                                            ...
                                            ?>
                                                <tr>
                                                    <td style="width:25px;"><?php echo $data['destinateur']; ?></td>
                     ...
                     <a href="delete-ms.php?id=<?php echo $data['id_msg']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Êtes-vous sûr ?')")><i class="icon-trash"></i></a></td>
                                                </tr>
                                            <?php   
                                            }
                                            ?>
