...
//exple:Pour $page=2 : $page-1=1, 1*5=5 => Nous lisons les entrées à partir de l'entrée 5 soit la sixième (qui est la première de la deuxième page)
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <i class="icon-edit"></i> Modifier</a>|<a href="delete-barang.php?id=<?php echo $data['id']; ?>" class="btn" onclick="return confirm('Êtes-vous sûr ?')")><i class="icon-trash"></i>supprimer</a></td>
                                                </tr>
                                            <?php   
                                            }
                                            ?>
