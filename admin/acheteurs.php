                            ...
                            <div class="block-content collapse in">
                            	 <table class="table table-bordered table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            $rr="SELECT * FROM client LIMIT $start, $per_page";
											...
											?>
												<tr>
                                                    ...
                                                    <td><?php echo $data['wilaya']; ?></td>
                                                     <td><?php echo $data['gest']; ?></td>
                 <td><a href="supclient.php?id=<?php echo $data['id_client']; ?>" onclick="return confirm('Êtes-vous sûr ?')" class="btn btn-danger" >Supprimer</a></td>
                                                </tr>
											<?php	
											}
											?>
