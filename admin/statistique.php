...
<br>
 ...
 <div class="CSSTableGenerator" >
                     ...
                     <?php $sql=$db->query("select * from client ");
                                           

                                                $row_num1 =  $sql->num_rows;
                                    ?>
            		...
            		<tr  class="media" id="carga_30" >
            			<td class="media-body">
            				<h4 class="media-heading font-yellow text-bold hidden-xs">Nombre d'inscrit sur le site</h4>
                            </td>
                        <td  style=" width: 72px !important;
    height: 30px;
    
    background-color: #eee;   "class="media-left">
            				<h4 style="text-align:center;"><?php echo $row_num1;?></h4>
            			</td>
              ...
              $sq=$db->query("select * from gestionnaire  ");
                                           $row_num11 =  $sq->num_rows;
            ...
            <table id="tableReport" class="table table-bordered table-striped table-hover ">
            	<tbody>
            		<tr  class="media" id="carga_30" >
            			...
            			<td class="media-body">
            				<h4 class="media-heading font-yellow text-bold hidden-xs">Nombre total de gestionnaire</h4>
    ...
    background-color: #eee;   "class="media-left">
            				<h4 style="text-align:center;"><?php echo  $row_num11;?></h4>
            			</td>
