...
if(isset($_POST["query"]))
{
 ...
 $query = "
  ...
  OR quantite_achete LIKE '%".$search."%'
   ...
   <tr>
    ...
    <td>'.$row["forme"].'</td>
          ...
          <td>'.$row["dosage"].'</td> 
           ...
           <td><a href="edit-barang.php?id='.$row['id'].'" class="btn btn-info">Modifier</a> 
<a href="delete-barang.php?id='.$row['id'].'" class="btn btn-danger">Supprimer</a>
           </td>
