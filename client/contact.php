...
<nav class="navbar navbar-light" style="background-color: #e3f2fd;">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a class="navbar-brand"  data-transition ="slide" href="contact.php">&nbsp;&nbsp;&nbsp;Messages reçus</a></li>
            <li><a class="navbar-brand"  data-transition ="slide" href="contacte.php">Messages envoyés</a></li>
                                    ...
                                    <?php              
                            $sql="SELECT * FROM messagerie WHERE destinateur= '$id'  and vers='vers1' ";
         ...
         <td style="background-color:;"class="inbox-small-cells"><i class="glyphicon glyphicon-envelope"></i>&nbsp;&nbsp;<label>Objet:</label></td>
                                  ...
                                  <td width="500px"class="view-message "><span class="teaser"><?php echo $r['objet'];?></span>
...
<span class="more"></span></td>
                                     ...
                                     <td class="view-message  text-right"><button  onclick="voir(<?php echo $r['id_msg'];?>)" data-toggle="modal" id="sup"type="button"class="btn btn-info  btn-sm" data-target="#modalvoir" ><i class="glyphicon glyphicon-eye-open"></i> Voir</button></td>
                                        
                                     <td class="view-message  text-right"><button onclick="delet(<?php echo $r['id_msg'];?>)"  data-toggle="modal" id="sup"type="button"class="btn btn-danger btn-sm" data-target="#modaldelete" ><i class="glyphicon glyphicon-remove"></i> Supprimer</button></td>
                                  
                                     
                                     <td class="view-message  text-right"><?php echo $r['date_envoie'];?></td>
                              </tr>
